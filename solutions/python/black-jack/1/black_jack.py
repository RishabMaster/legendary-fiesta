...
def value_of_card(card):
    ...
    """
    if len(card) == 1 and ord(card) in range(ord("2"), ord("9")+1):
        return int(card)
    elif len(card) == 2 and card == "10":
        return int(card)
...
def is_blackjack(card_one, card_two):
    ...
    if card_one == "A" and (card_two == "K" or card_two == "Q" or card_two == "J" or card_two == "10"):
        return True
    elif card_two == "A" and (card_one == "K" or card_one == "Q" or card_one == "J" or card_one == "10"):
        return True
    else:
        return False
...
def can_double_down(card_one, card_two):
    ...
    if addition == 9 or addition == 10 or addition == 11:
        return True
    else:
        return False
